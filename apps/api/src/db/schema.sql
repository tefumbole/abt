...
CREATE TABLE IF NOT EXISTS members (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  INDEX idx_members_sort_order (sort_order)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS system_settings (
  ...
  timezone_offset VARCHAR(10) DEFAULT '+01:00',
  currency_position VARCHAR(20) DEFAULT 'prefix',
  staff_access VARCHAR(20) DEFAULT 'all',
  date_format VARCHAR(20) DEFAULT 'd-m-Y',
  invoice_format VARCHAR(40) DEFAULT 'standard',
  letter_serial_no VARCHAR(100) DEFAULT NULL,
  default_warehouse_id CHAR(36) DEFAULT NULL,
  default_biller_id CHAR(36) DEFAULT NULL,
  default_unit_id CHAR(36) DEFAULT NULL,
  default_category_id CHAR(36) DEFAULT NULL,
  tax_rate DECIMAL(8,2) DEFAULT 0,
  pdf_watermark_url TEXT DEFAULT NULL,
  pdf_watermark_file_path VARCHAR(255) DEFAULT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
