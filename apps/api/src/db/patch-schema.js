...
export const SCHEMA_PATCHES = [
  ...
  'ALTER TABLE system_settings ADD COLUMN timezone VARCHAR(64) DEFAULT \'Africa/Douala\'',
  'ALTER TABLE system_settings ADD COLUMN timezone_offset VARCHAR(10) DEFAULT \'+01:00\'',
  'ALTER TABLE system_settings ADD COLUMN currency_position VARCHAR(20) DEFAULT \'prefix\'',
  'ALTER TABLE system_settings ADD COLUMN staff_access VARCHAR(20) DEFAULT \'all\'',
  'ALTER TABLE system_settings ADD COLUMN date_format VARCHAR(20) DEFAULT \'d-m-Y\'',
  'ALTER TABLE system_settings ADD COLUMN invoice_format VARCHAR(40) DEFAULT \'standard\'',
  'ALTER TABLE system_settings ADD COLUMN letter_serial_no VARCHAR(100) DEFAULT NULL',
  'ALTER TABLE system_settings ADD COLUMN default_warehouse_id CHAR(36) DEFAULT NULL',
  'ALTER TABLE system_settings ADD COLUMN default_biller_id CHAR(36) DEFAULT NULL',
  'ALTER TABLE system_settings ADD COLUMN default_unit_id CHAR(36) DEFAULT NULL',
  'ALTER TABLE system_settings ADD COLUMN default_category_id CHAR(36) DEFAULT NULL',
